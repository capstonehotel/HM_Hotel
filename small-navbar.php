    ...
    <div class="collapse navbar-collapse ">
      <div class="sm-ul navbar-custom-menu ">
          <ul class="nav navbar-nav  tooltip-demo">
            <li>
              <a  data-toggle="tooltip" data-placement="bottom"   title="Booking Cart"  href="<?php echo 'index.php';  ?>"> 
...
?>
            ...
            <!-- <li class="box-footer no-padding">  -->
                <li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;"
                    href="../guest/profile.php" data-toggle="lightbox" >Account<!--  <span class="pull-right badge bg-blue">31</span> --></a></li>
                ...
                <li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;" 
                href="../guest/bookinglist.php" data-toggle="lightbox">Bookings <!-- <span class="pull-right badge bg-green">12</span> --></a></li>
