...
<?php } ?>
                                    <?php if ($row['STATUS'] == "Confirmed" ) { ?>
                                        <a href="controller.php?action=checkin&code=<?php echo $row['CONFIRMATIONCODE']; ?>" onclick="checkinBooking()" class="btn btn-success btn-sm ml-2" ><i class="icon-edit">Check in</a>
                                        <a href="controller.php?action=cancel&code=<?php echo $row['CONFIRMATIONCODE']; ?>"  onclick="cancelBooking()" class="btn btn-danger btn-sm ml-2" ><i class="icon-edit">Cancel</a>
                                    <?php } elseif($row['STATUS'] == 'Checkedin') {?>
                                        <a href="controller.php?action=checkout&code=<?php echo $row['CONFIRMATIONCODE'];?>" onclick="checkoutBooking()" class="btn btn-warning btn-sm ml-2" ><i class="icon-edit">Check out</a>
                                    <?php } elseif($row['STATUS'] == 'Checkedout') {?>
                                <a href="controller.php?action=delete&code=<?php echo $row['CONFIRMATIONCODE']; ?>" onclick="deleteBooking()" class="btn btn-danger btn-sm ml-2" ><i class="icon-edit">Delete</a>
                                    <?php } else {?>
                                        <a href="controller.php?action=confirm&code=<?php echo $row['CONFIRMATIONCODE']; ?>" onclick="confirmBooking()" class="btn btn-success btn-sm ml-2"  ><i class="icon-edit">Confirm</a>
