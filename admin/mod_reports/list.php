...
<style>
    ...
    .print-section {
        display: none; /* Hide print section initially */
    }
    @media print {
        .print-section {
            display: block;
...
<!-- Print Section (hidden by default, shown during print) -->
<div class="print-section" id="printSection">
    ...
    if (isset($_GET['code']) && !empty($_GET['code'])) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo 'No records found for the provided confirmation code.';
            exit;
        }
...
$(document).ready(function() {
    ...
    $(document).on('click', '.print-btn', function() {
        ...
        window.location.href = 'list.php?code=' + code; // Reload the page with the code parameter
