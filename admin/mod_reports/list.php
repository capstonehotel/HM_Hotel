                                ...
                                if (!$result) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="printreport.php?code=<?php echo $confirmation_code; ?>" target="_blank"class="btn btn-sm btn-primary"><i class="icon-edit"></i> View</a>
                                                <a href="printreport.php?code=<?php echo $confirmation_code; ?>" target="_blank" class="btn btn-primary">View Report</a>
