...
$id = $_GET['id'];
$sql = $query = "SELECT * FROM tblaccomodation WHERE ACCOMID = $id";
...
if (isset($_POST['save_accomodation'])) {
  ...
  $ACCOMDESC = $_POST['ACCOMDESC'];
    ...
    if ($conn->query($sql) === TRUE) {
        // echo "<script>alert('Accomodation updated successfully');</script>";
        //  redirect("index.php");
        echo "<script>
                            swal({
                                title: 'Updated!',
        ...
        // echo "<script>alert('Error updating Accomodation');</script>";
        echo "<script>
        swal({
            title: 'Error!',
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    ...
                    <div class="col-md-12">
                       <input required class="form-control input-sm" id="ACCOMODATION" name="ACCOMODATION" placeholder=
                          "Accomodation" type="text" value="<?php echo $row["ACCOMODATION"]; ?>">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-md-12 col-sm-12 ">
                    ...
                    <div class="col-md-12">
                       <input required class="form-control input-sm" id="ACCOMDESC" name="ACCOMDESC" placeholder=
                          "Description" type="text" value="<?php echo $row["ACCOMDESC"]; ?>">
                    </div>
                  </div>
                </div>
            </div>
