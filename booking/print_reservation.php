...
<!-- DataTables CSS -->
<!-- <link href="https://mcchmhotelreservation.com/css/dataTables.bootstrap.css" rel="stylesheet"> -->
...
<div id="accom-title"  > 
    ...
    <form action="index.php?view=payment" method="post"  name="" >
           ...
           Greetings from HM Mini Hotel Reservation!<br/><br/>
        ...
        <table class="table table-hover" style="font-size:11px">
              ...
              <th align="center" width="120">Room Type</th>
               <th align="center" width="120">Checked in</th>
                <th align="center" width="120">Checked out</th>
...
If you have any questions, please email at Hmminihotel.com or call (034) 4713 – 135
<br/><br/>
Thank you for choosing Hm Mini Hotel
<br/><br/>
