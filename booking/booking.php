                ...
                <div class="col-xs-12 col-sm-12" align="right">
                    ...
                    if (isset($_SESSION['monbela_cart'])) {
                        ...
                        if (isset($_SESSION['GUESTID'])) {
                            ?>
                            <a href="https://mcchmhotelreservation.com/index.php?view=payment" class="btn btn-primary" align="right" name="continue">Continue Booking</a>
                            <?php
                            
                        } else {
                            ?>
                            <a href="https://mcchmhotelreservation.com/index.php?view=logininfo" class="btn btn-primary" align="right" name="continue">Continue Booking</a>
                            <?php
                        }
                    } else {
